...
(function(){
  ...
  const ACCESSORY_PORTRAIT_IMAGES={glasses:'accessory-glasses-portrait.png',headband:'accessory-headband-portrait.png',helmet:'accessory-helmet-portrait.png',earrings:'accessory-earrings-portrait.png',scarf:'accessory-scarf-portrait.png'};
  ...
  function characterMarkup(size='large',override={},presentation={}){
    ...
    const fashion=Object.assign({jacket:'none',gloves:'none',shoes:'boots'},state.v5?.fashion||{});if(presentation.hideJacket)fashion.jacket='none';const sources=renderedSources(c,maskStyle,fashion);
